...
namespace ShopToys.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(ManagerShopPRN211Context context)
        {
            _context = context;
        }
        ...
        {
            var managerShopPRN211Context = _context.Accounts.Include(a => a.Role).Include(a => a.Employees).Include(a => a.Customers);
            //List<SelectListItem> isStatus = new List<SelectListItem>();
            //isStatus.Add(new SelectListItem() { Text = "Active", Value = "1" });
            //isStatus.Add(new SelectListItem() { Text = "Ban", Value = "0" });
        ...
        public async Task<IActionResult> Create([Bind("AccountId,Username,Password,RoleId,Active")] Account account)
        {
